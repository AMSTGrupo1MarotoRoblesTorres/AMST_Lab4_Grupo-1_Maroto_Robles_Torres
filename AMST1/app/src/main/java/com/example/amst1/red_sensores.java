...
public class red_sensores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.id_creado=(String)login.getExtras().get("id");
        revisarSensores();
    }
    private void revisarSensores(){
        ...
        String url_temp = "https://amst-labx.herokuapp.com/api/sensores/"+id_creado;
        ...
        String url_humedad="https://amst-labx.herokuapp.com/api/sensores/"+id_creado;
        ...
        String url_peso = "https://amst-labx.herokuapp.com/api/sensores/"+id_creado;
    ...
    public void agregar_temperatura(View v){
        Intent nueva_temperatura = new Intent(getBaseContext(), nueva_temperatura.class);
        nueva_temperatura.putExtra("token", token);
        startActivity(nueva_temperatura);
    }
}